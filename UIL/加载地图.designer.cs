namespace SGEDSystem
{
    partial class Form2
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.textBox1.Text = "使用加载地图按钮，将系统支持的地图数据文件添加到界面上并且让其可视化。快捷键为Ctrl+N。在新会话中首次使用系统添加数据按钮时，将自动返回到上次添加数据的位置。" +
    "";
            // 
            // pictureBox1
            // 
            ...
            this.pictureBox1.Size = new System.Drawing.Size(316, 293);
